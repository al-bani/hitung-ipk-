...
<body>
    <?php if($type_n == "abjad"){?>
        <div class="long-form">
        <form method="post" action="index.php?jumlah_matkul=<?php echo $jml_matkul?>&tipe_nilai=<?php echo $type_n ?>" autocomplete="off">
    ...
    <?php } else if($type_n == "num"){ ?>
        <div class="long-form">
        <form method="post" action="index.php?jumlah_matkul=<?php echo $jml_matkul?>&tipe_nilai=<?php echo $type_n ?>">
