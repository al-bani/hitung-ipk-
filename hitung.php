...
<?php
    ...
    if (!isset($_GET['jumlah_matkul']) || !isset($_GET['tipe_nilai'])){
...
?>
        <?php if($type_n == "abjad"){?>
            <div class="form">
            <form method="post" action="hitung.php?jumlah_matkul=<?php echo $jml_matkul?>&tipe_nilai=<?php echo $type_n ?>">
            <h2>Hitung IPK/IPS menggunakan Penilaian Abjad</h2>
        ...
        <?php } else if($type_n == "num"){ ?>
            <div class="form">
            <form method="post" action="hitung.php?jumlah_matkul=<?php echo $jml_matkul?>&tipe_nilai=<?php echo $type_n ?>">
            <h2>Hitung IPK/IPS menggunakan Penilaian angka</h2>
                <?php $j =0; for($i = 0; $i < $jml_matkul; $i++){?>
                    <label>   Mata kuliah ke-<?php echo $j+1?> : </label>
                    <input type="text" name='nama_matkul[]' placeholder="input nama matakuliah">
                    <label>   Jumlah SKS : </label>
